...
void Uart_init()
{
    ...
    // “актирование модул€ было включено в
	...
	SciaRegs.SCILBAUD    = 0x0006;  // дл€ 256000 бод
...
{
	EALLOW;
	GpioCtrlRegs.GPAPUD.bit.GPIO28 = 0;    // подт€жка на GPIO28 (SCIRXDA)
	GpioCtrlRegs.GPAPUD.bit.GPIO29 = 1;	   // откл подт€жки на GPIO29 (SCITXDA)
...
interrupt void cpu_timer0_isr(void)
{
	...
	// запрещаем прерывани€ на врем€ обработки и передачи
	DINT;
